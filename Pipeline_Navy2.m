...
for i = 1:nRaw
    ...
    % Onset and duration of each trial - Recall this is in a for loop
    ...
    for j = 1:4
        ...
        % The base_names{j} is now guaranteed to be 'LG' or 'HG' based on the trial's START code (41 or 42) from step 3.
    ...
    combined_events = [baseline_events_cell; trial_events];
